...
export default function SignUpPage() {
  return (
    <div className="flex min-h-[calc(100dvh-4rem)] flex-col items-center justify-center px-4 py-12">
      ...
      <h1 className="mt-8 text-[28px] leading-[34px] font-semibold tracking-[-0.02em] text-ink">Create your account</h1>
      <p className="mt-2 mb-8 text-ink-2">Free plan, no card needed.</p>
